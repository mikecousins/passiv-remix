...
export function TableHead({
  className,
  ...props
}: React.ComponentPropsWithoutRef<'thead'> & { className?: string }) {
  return (
    <thead
...
export function TableHeader({
  className,
  ...props
}: React.ComponentPropsWithoutRef<'th'> & { className?: string }) {
...
export function TableCell({
  ...
  children,
  ...props
}: React.ComponentPropsWithoutRef<'td'> & { className?: string }) {
